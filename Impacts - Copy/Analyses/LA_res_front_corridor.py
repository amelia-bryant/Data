...
df2 = pd.read_csv('LA_Res_Front_Corridor.csv')  # Replace 'second_csv_file.csv' with the actual file path
...
# Plotting only the first signal from df2 with x-axis values in green
if signals2:
